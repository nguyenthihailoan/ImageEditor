package com.gallery.editor.image.photoeditor.widgets.simplecropview;
...
import com.gallery.editor.image.photoeditor.widgets.simplecropview.animation.SimpleValueAnimator;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.animation.SimpleValueAnimatorListener;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.animation.ValueAnimatorV14;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.animation.ValueAnimatorV8;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.callback.Callback;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.callback.CropCallback;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.callback.LoadCallback;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.callback.SaveCallback;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.util.Logger;
import com.gallery.editor.image.photoeditor.widgets.simplecropview.util.Utils;
...
public class CropImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mViewWidth = viewWidth - getPaddingLeft() - getPaddingRight() - getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);
        mViewHeight = viewHeight - getPaddingTop() - getPaddingBottom() - getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);
    }
    ...
    public void showBorderCropView() {
        isShowBorder = true;
        mShowHandle =true;
        mOverlayColor = TRANSLUCENT_BLACK;
    ...
    public void hidenBorderCropView() {
        isShowBorder = false;
        mShowHandle =false;
